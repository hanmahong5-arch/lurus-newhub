            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 w-full'>
              <div className='text-left'>
                ...
                <div className='flex flex-col gap-4'>
                  <a
                    href='https://docs.lurus.cn/wiki/project-introduction/'
                    target='_blank'
                  ...
                  <a
                    href='https://docs.lurus.cn/support/community-interaction/'
                    target='_blank'
                    rel='noopener noreferrer'
                    className='!text-semi-color-text-1'
                  >
                  ...
                  <a
                    href='https://docs.lurus.cn/wiki/features-introduction/'
                    target='_blank'
                    rel='noopener noreferrer'
                    className='!text-semi-color-text-1'
                  >
              ...
              <div className='text-left'>
                ...
                <div className='flex flex-col gap-4'>
                  <a
                    href='https://docs.lurus.cn/getting-started/'
                    target='_blank'
                    rel='noopener noreferrer'
                    className='!text-semi-color-text-1'
                  >
                  ...
                  <a
                    href='https://docs.lurus.cn/installation/'
                    target='_blank'
                    rel='noopener noreferrer'
                    className='!text-semi-color-text-1'
                  >
      ...
      {footer ? (
        <div className='relative'>
          <div
            ...
            dangerouslySetInnerHTML={{ __html: sanitizeOperatorHtml(footer) }}
          ></div>
